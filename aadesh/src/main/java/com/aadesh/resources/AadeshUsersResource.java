...
@Path("/loginusers")
public class AadeshUsersResource {
	private final Logger logger = Logger.getLogger(AadeshUsersResource.class.getName());
	private final AadeshUserDAO userDAO;
	private final TenantDAO tenantDAO;

	public AadeshUsersResource(AadeshUserDAO userDAO, TenantDAO tenantDAO) {
