...
angular.module('myWebApp')
	.controller('tapinrequestController', tapinrequestController);

tapinrequestController.$inject = ['$http', '$rootScope', '$scope', '$state', 'restAPIService', 'dialogs','$location'];

function tapinrequestController ($http, $rootScope, $scope, $state, restAPIService, dialogs,$location) {
	$scope.tenantsData = [];
...
//	function addPinRequest() {
	$scope.addPinRequest = function() {
		...
		$scope.tenant.tenantParent = $scope.loginID;
